...
/* $(function(){
	$("#dbToExcel").click(function(i,e){
		$.ajax({
			url : "/user_dbToExcel.action",
				type : "post",
				dataType : "json",
...
<body>
    ...
    <div class="pagin">
        ...
        <s:else>
						<li class="paginItem"><a href="user_findByTJ.action?page=1">1</a></li>
						<li class="paginItem"><a href="user_findByTJ.action?page=<s:property value="%{currentPage-1}"/>"><span class="pagepre"></span></a></li>  
		</s:else>
        <s:if test="%{currentPage != totalPage}">
        				<li class="paginItem"><a href="user_findByTJ.action?page=<s:property value="%{currentPage+1}"/>">next</a></li>
						<li class="paginItem"><a href="user_findByTJ.action?page=<s:property value="totalPage"/>"><span class="pagenxt"></span></a></li>
					</s:if>
